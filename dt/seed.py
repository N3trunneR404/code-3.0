"""Seeding utilities for populating DTState without Flask dependencies."""
            ...
            "nodes": [
                ...
                },
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=5200,
                        memory_type="DDR5",
                        accelerators=["gpu:nvidia-h100", "fpga:xilinx-u250"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64"],
                ...
                },
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=4800,
                        memory_type="DDR5",
                        accelerators=["gpu:nvidia-rtx6000"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64", "riscv64"],
                        wasm_support=True,
                    ),
                    "labels": {
            ...
            "nodes": [
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=4400,
                        memory_type="DDR5",
                        accelerators=["gpu:nvidia-rtx3090"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64"],
                ...
                },
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=4266,
                        memory_type="DDR4",
                        accelerators=["gpu:nvidia-rtx3080"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64"],
                ...
                },
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=3600,
                        memory_type="DDR4",
                        accelerators=["gpu:nvidia-rtx3070"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64"],
            ...
            "nodes": [
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=3600,
                        memory_type="DDR4",
                        accelerators=["gpu:nvidia-tesla-t4"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["arm64", "riscv64"],
            ...
            "nodes": [
                {
                    ...
                    "hardware": dict(
                        ...
                        memory_mhz=2133,
                        memory_type="LPDDR5",
                        accelerators=["npu:qualcomm-hvx"],
                    ),
                    "runtime": dict(
                        native_formats=["native"],
                        emulation_support=["amd64"],
                        wasm_support=True,
                    ),
                    "labels": {
