"""V6: Drift robustness study across phases."""
...
def run(dt: DTClient | str | None = None, phases: int = 3, per_phase: int = 5) -> None:
    """Run experiment with origin context and scaling."""
    client = ensure_client(dt)
    print("=== V6 Drift Robustness ===")
    ...
    for p in range(phases):
        ...
        for i in range(per_phase):
            ...
            result = client.plan(job, strategy="greedy", dry_run=True)
            result["phase"] = p
